...
# Hyperparameters
learning_rate = 0.00005 # 0.0001 --------------------> learning step
gamma = 0.98 #---------------------------------------> original 0.98, modified 0.99
buffer_limit = 50000 #original 50000, modified 100000
batch_size = 32 # original 32, modified 64 (learning rate 키우고 batch size는 줄여보기)
train_start = 10000 #5000
...
class ReplayBuffer():
    def __init__(self):
        self.buffer = collections.deque(maxlen=buffer_limit) # history 저장, deque는 queue로, 먼저들어온걸 버리기

    def put(self, transition):
        self.buffer.append(transition)

    def sample(self, n): #sample n
...
# Q value: stae & action -> Return
    def __init__(self):
        ...
        self.fc4 = nn.Linear(128, 5) #--------------------> modify to 7?
    ...
    #using self network & forwarding learning through observation
